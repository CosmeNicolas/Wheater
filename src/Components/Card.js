                    ...
                    <div className="row g-0">
                        <div className="col-md-4">
                            ...
                            <h1 className="card-temp">{(weather.main.temp - 273.15).toFixed(1)}°C</h1>
                                <img src="https://images.unsplash.com/photo-1504608524841-42fe6f032b4b?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=465&q=80" className="img-fluid  h-100 " alt="cloud"
                            /></div>
                            <div className="col-md-8">
                                <div className="card-body text-start mt-2">
                                    ...
                                    <h5 className="card-text">TeSensacion termica:{(weather.main.feels_like - 273.15).toFixed(1)}°c</h5>
